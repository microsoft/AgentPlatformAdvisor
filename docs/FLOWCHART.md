...
flowchart TD
    ...
    Q4 -->|"⚠️ Complex workflows / multi-agent"| Q4D["AB:0 · CS:3 · Foundry:3\n→ HARD RULE: AB=0"]
    ...
    PREF --> RUNTIME{"**Are Copilot Studio and Foundry**\nthe top two within 2 points?"}
    RUNTIME -->|No| RESULT
    RUNTIME -->|Yes| Q9["**One final distinction**\nWho should operate the agent runtime?"]
    Q9 -->|Microsoft-managed platform| Q9A["Prefer Copilot Studio over Foundry\nScores stay unchanged"]
    Q9 -->|"⚠️ Engineering-owned runtime"| Q9D["HARD RULE: AB=0, CS=0\nRecommend Foundry"]
    Q9A & Q9D --> RESULT

    RESULT["**Recommendation Thresholds**\n12–15: Strong fit\n8–11: Good fit\n4–7: Partial fit\n0–3: Not recommended"]
    ...
    style RUNTIME fill:#e8f0fe,stroke:#4a86e8
